...
function AdminSubmissions() {
  ...
  const onTechCheck = async (id: number, passed: boolean) => {
    try {
      ...
      alert(
        passed
          ? "Technical check approved successfully"
      ...
      console.error("tech check error full:", e)
      console.error("tech check url:", e?.config?.url)
      console.error("tech check status:", e?.response?.status)
      console.error("tech check data:", e?.response?.data)
